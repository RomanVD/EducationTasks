...
namespace EducationTasks.Task1
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            // 1) Вызывается конструктор child, перед его вызовом инициализируются статические поля и свойства, для кторых указано какое либо значение при объявлении
            // 2) Вызывается конструктор parent, перед его вызовом инициализируются поля и свойства, для кторых указано какое либо значение при объявлении
